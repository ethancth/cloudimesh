<div>
  @if (Gate::check('addTeamMember', $team))
    ...
    <x-form-section submit="addTeamMember">
      <x-slot name="title">
        {{ __('Add Tenant Member') }}
      </x-slot>

      <x-slot name="description">
        {{ __('Add a new member to your tenant, allowing them to collaborate with you.') }}
      </x-slot>
      ...
      <x-slot name="form">
        ...
        <div class="mb-3">
          {{ __('Please provide the email address of the person you would like to add to this tenant. The email address must be associated with an existing account.') }}
        </div>
  ...
  @if ($team->teamInvitations->isNotEmpty() && Gate::check('addTeamMember', $team))
    ...
    <div class="mt-4">
      ...
      <x-slot name="description">
        {{ __('These people have been invited to your tenant and have been sent an invitation email. They may join the tenant by accepting the email invitation.') }}
      </x-slot>
  ...
  @if ($team->users->isNotEmpty())
    ...
    <x-action-section>
      ...
      <x-slot name="description">
        {{ __('All of the people that are part of this tenant.') }}
      </x-slot>
